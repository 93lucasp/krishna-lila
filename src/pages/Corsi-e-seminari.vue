        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-flex align-items-center">
              <div>
                <h1 class="heroCourse__title">Titolo corsi</h1>
                ...
                <a href="#courses" class="btn btn-primary" v-smooth-scroll>Scopri i corsi</a>
              </div>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
              <g-image src="/uploads/yoga.svg" class="heroCourse__illustration" />
            </div>
          </div>
        </div>
      </div>
