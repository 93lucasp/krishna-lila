    ...
    <div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-flex align-items-center">
              <div>
                <h1 class="heroCourse__title">Titolo consulenze</h1>
            ...
            <div class="col-lg-6 text-center text-lg-right">
              <g-image src="/uploads/energy.svg" class="heroCourse__illustration" />
            </div>
          </div>
        </div>
      </div>
      <div class="container py-5 my-5">
        ...
        <div class="row py-5 my-5" id="courses">
          ...
          <CourseBox v-for="consult in $page.consulting.edges" :title="consult.node.title" :path="consult.node.path" :image="consult.node.image" :key="consult.id"/>
